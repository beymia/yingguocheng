...
//新建拼單
export const pintuan_create = (data) => ajax('/merger-team/create-team', data, 'post', 1)
//團隊點單
...
//邀請成員二維碼
export const pintuan_invite = (data) => ajax('/qr-code/invite-code', data, 'post', 1)
//拼團鎖定
...
//組團詳情
export const pintuan_info = (data) => ajax('/merger-team/merger-detail', data, 'post', 1)
//取消拼團
